// Type definitions for Screeps 3.2.1
...
declare const COMMODITIES: Record<CommodityConstant | MineralConstant | RESOURCE_GHODIUM | RESOURCE_ENERGY,
    {
        level?: number;
        amount: number;
        cooldown: number;
...
type LookForAtAreaResultWithPos<T, K extends keyof LookAtTypes = keyof LookAtTypes> =
